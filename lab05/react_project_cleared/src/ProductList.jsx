...
export function ProductList(val){
    ...
    const handleLogin=()=>{
        ...
        if(password==='edit' && username==='edit'){
            setLoggedIn(true)
    ...
    <div id="content">
        ...
        <div id="filter1">
            ...
            {
                !loggedIn && !logInDialog ? <button onClick={()=>setLogInDialog(true)}>Log In</button> :null
            }{
            ...
            {products.length > 0 && (editVisibility ? null:
                ...
                {products.map(product => (
                    <li key={product.id}>
                        ...
                        {loggedIn ? <button onClick={()=>handleClickEdit(product)}>edit</button>:null}
                    </li>
